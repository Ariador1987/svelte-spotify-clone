<script lang="ts">
	import { Button, TrackList } from '$components';
	...
	// here we get playlistTrack object is not what we want, our TrackList component expects an array of tracks
	...
	$: {
		filteredTracks = [];
		tracks.items.map((item: SpotifyApi.PlaylistTrackObject) => {
...
>
	...
	<div class="playlist-actions">
		...
		{:else if isFollowing !== null}
			...
			>
				<Button element="button" type="submit" variant="outline" bind:this={followButton}>
					<Heart
						aria-hidden
						focusable="false"
